...
_veh setVariable ["GOM_fnc_usedEjectionSeats",_usedEjectionSeats];
systemchat str _usedEjectionSeats;
...
(speed _veh * 0.22222278 * (sin _dir)),
(speed _veh * 0.22222278 * (cos _dir)),
_velZ + 35
