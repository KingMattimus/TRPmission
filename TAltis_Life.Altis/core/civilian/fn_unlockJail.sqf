...
_pdoor1 animateSource [format ["Door_%1_source", 1], 0];
_pdoor2 animateSource [format ["Door_%1_source", 1], 0];
_pdoor3 animateSource [format ["Door_%1_source", 1], 0];
_pdoor4 animateSource [format ["Door_%1_source", 1], 0];
