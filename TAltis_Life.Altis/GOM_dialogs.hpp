...
////////////////////////////////////////////////////////
// GUI EDITOR OUTPUT START (by Grumpy Old Man, v1.063, #Kygoce)
////////////////////////////////////////////////////////
...
text = "low threshold";         //--- ToDo: Localize;
...
text = "high threshold";         //--- ToDo: Localize;
x = 9 * GUI_GRID_W + GUI_GRID_X;
...
text = "boost display";         //--- ToDo: Localize;
...
{
idc = 1008;
text = "Nitro/Speed Ratio:";         //--- ToDo: Localize;
