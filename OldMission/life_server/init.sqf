...
private["_dome","_rsb"];
_dome = nearestObject [[getPosATL fed_res select 0, getPosATL fed_arm select 1, 0],"Land_Dome_Big_F"];
_rsb = nearestObject [[getPosATL fed_res select 0, getPosATL fed_arm select 1, 0],"Land_cargo_house_V1_F"];
