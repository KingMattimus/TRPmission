...
[[4, format["%1 is hacking into Trole Corp Central Criminal Database [T.C.C.D] to break prisoners out of the jail!", name player]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
