class Trole_Life_My_Group_Diag {
	idd = 2620;
...
class Trole_Life_Browse_Gang_Diag {
	idd = 2520;
...
class Trole_Life_Create_Group_Diag {
	idd = 2520;
...
class Trole_Life_Gang_Prompt
{
	...
	class controls 
	{
		...
		class life_gang_browse : Life_RscButtonMenu {
			...
			colorBackground[] = {0, 0, 0, 0};
			onButtonClick = "closeDialog 0; createDialog ""Trole_Life_Browse_Gang_Diag""";
		...
		class life_gang_create_button : Life_RscButtonMenu {
			...
			text = "$STR_Gang_Create";
			colorBackground[] = {0, 0, 0, 0};
			onButtonClick = "closeDialog 0; createDialog ""Trole_Life_Create_Group_Diag""; ctrlShow[2522,true]";
