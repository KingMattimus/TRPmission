    ...
    switch (_side) do
    {
            case west:
            {
                    _return = [
							...
							["cop_spawn_6","Jail Dispatch","\a3\ui_f\data\map\GroupIcons\badge_rotate_0_gs.paa"]
                    ];
            };
            ...
            case civilian:
            {
                    ...
                    _return = [
									...
									["reb_spawn_4","Molos Outpost","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
            ...
            case independent: {
                    _return = [
							...
							["medic_spawn_4","Sofia Clinic","\a3\ui_f\data\map\MapControl\hospital_ca.paa"]
                    ];
            };
    };
