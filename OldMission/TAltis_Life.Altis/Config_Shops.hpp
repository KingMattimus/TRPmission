class WeaponShops {
    ...
    class cop_basic {
        ...
        items[] = {
			...
			{ "arifle_MX_Black_F", "", 65000, { "life_coplevel", "SCALAR", 2 } },
			{ "arifle_MXM_Black_F", "", 85000, { "life_coplevel", "SCALAR", 3 } },
			{ "srifle_DMR_03_F", "", 500, { "life_coplevel", "SCALAR", 4 } },
			{ "arifle_MXM_F", "", 85000, { "life_coplevel", "SCALAR", 7 } },
            { "arifle_sdar_F", "", 25000, { "life_coplevel", "SCALAR", 2 } },
            { "arifle_MX_SW_Black_F", "Swat MX SW", 500, { "life_swatlevel", "SCALAR", 1 } },
