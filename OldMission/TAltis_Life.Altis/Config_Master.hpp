...
class Life_Settings {
	...
	allowedSavedVirtualItems[] = { "pickaxe", "fuelEmpty", "fuelFull", "spikeStrip", "lockpick", "defuseKit", "storageSmall", 
									...
									"goat_raw","painkiller","adrenaline","cyanide","armblastingcharge"
									};
};
...
class VirtualItems {
	//Misc
	VITEMMACRO(pickaxe, "STR_Item_Pickaxe", "pickaxe", 2, 750, 350, false, -1, "icons\ico_fuelempty.paa")
	...
	VITEMMACRO(goldbar, "STR_Item_GoldBar", "goldBar", 12, -1, 95000, false, -1, "icons\ico_goldBar.paa")
	VITEMMACRO(blastingcharge, "STR_Item_BCharge", "blastingCharge", 15, 35000, -1, true, -1, "icons\ico_blastingCharge.paa")
	VITEMMACRO(armblastingcharge, "STR_Item_armBCharge", "armblastingCharge", 15, 35000, -1, true, -1, "icons\ico_blastingCharge.paa")
	...
	//Mined Items
	VITEMMACRO(oil_unprocessed, "STR_Item_OilU", "oilUnprocessed", 3, -1, -1, false, -1, "icons\ico_oilUnprocessed.paa")
	VITEMMACRO(oil_processed, "STR_Item_OilP", "oilProcessed", 2, -1, 3200, false, -1, "icons\ico_oilProcessed.paa")
	VITEMMACRO(copper_unrefined, "STR_Item_CopperOre", "copperUnrefined", 3, -1, -1, false, -1, "icons\ico_copperUnrefined.paa")
	VITEMMACRO(copper_refined, "STR_Item_CopperIngot", "copperRefined", 2, -1, 2500, false, -1, "icons\ico_copperRefined.paa")
	VITEMMACRO(iron_unrefined, "STR_Item_IronOre", "ironUnrefined", 3, -1, -1, false, -1, "icons\ico_ironUnrefined.paa")
	VITEMMACRO(iron_refined, "STR_Item_IronIngot", "ironRefined", 2, -1, 3200, false, -1, "icons\ico_ironRefined.paa")
	VITEMMACRO(salt_unrefined, "STR_Item_Salt", "saltUnrefined", 2, -1, -1, false, -1, "icons\ico_saltRefined.paa")
	VITEMMACRO(salt_refined, "STR_Item_SaltR", "saltRefined", 1, -1, 1450, false, -1, "icons\ico_saltUnrefined.paa")
	VITEMMACRO(sand, "STR_Item_Sand", "sand", 2, -1, -1, false, -1, "icons\ico_sand.paa")
	VITEMMACRO(glass, "STR_Item_Glass", "glass", 1, -1, 1450, false, -1, "icons\ico_glass.paa")
	VITEMMACRO(diamond_uncut, "STR_Item_DiamondU", "diamondUncut", 3, -1, 750, false, -1, "icons\ico_diamondUncut.paa")
	VITEMMACRO(diamond_cut, "STR_Item_DiamondC", "diamondCut", 2, -1, 2000, false, -1, "icons\ico_diamondCut.paa")
	VITEMMACRO(rock, "STR_Item_Rock", "rock", 3, -1, -1, false, -1, "icons\rock.paa")
	VITEMMACRO(cement, "STR_Item_CementBag", "cement", 2, -1, 2000, false, -1, "icons\ico_cement.paa")
	VITEMMACRO(mushroom, "STR_Item_Mushroom", "mushroom", 2, -1, 1950, false, -1, "icons\mushroom.paa")
	

	//Drugs
	VITEMMACRO(heroin_unprocessed, "STR_Item_HeroinU", "heroinUnprocessed", 2, -1, 3000, true, -1, "icons\ico_heroinUnprocessed.paa")
	VITEMMACRO(heroin_processed, "STR_Item_HeroinP", "heroinProcessed", 1, -1, 3000, true, -1, "icons\heroine.paa")
	VITEMMACRO(meth_processed, "STR_Item_Methp", "methProcessed", 1, -1, 3000, true, -1, "icons\heroine.paa")
	VITEMMACRO(meth_unprocessed, "STR_Item_Methu", "methUnprocessed", 1, -1, 3000, true, -1, "icons\heroine.paa")
	VITEMMACRO(cannabis, "STR_Item_Cannabis", "cannabis", 2, -1, 1000, true, -1, "icons\ico_cannabis.paa")
	...
	VITEMMACRO(mash, "STR_Item_Mash", "mash", 1, -1, 1200, true, -1, "")
	VITEMMACRO(painkiller, "STR_Item_pkiller", "painkiller", 1, -1, 1200, true, -1, "icons\rations.paa")
	VITEMMACRO(adrenaline, "STR_Item_adrenaline", "adrenaline", 1, 500, 500, true, -1, "icons\Morphine.paa")
	VITEMMACRO(cyanide, "STR_Item_cyanide", "cyanide", 1, 500, 500, true, -1, "icons\death.paa")
	//DrinkC
	...
	VITEMMACRO(ziptie, "STR_Item_Ziptie", "ziptie", 1, 500, 500, true, -1, "icons\ico_zipties.paa")

	
	
	VITEMMACRO(underwatercharge, "STR_Item_Underwatercharge", "underwatercharge", 2, 35000, 10000, false, -1, "")
	VITEMMACRO(goldbarp, "STR_Item_GoldScrap", "goldbarp", 12, -1, 95000, false, -1, "icons\ico_valuablecoins.paa")
	VITEMMACRO(pharmblastingcharge, "STR_Item_pharmBCharge", "pharmblastingcharge", 2, 35000, 10000, false, -1, "icons\ico_blastingCharge.paa")
	VITEMMACRO(heliblastcharge, "STR_Item_heliblastcharge", "heliblastcharge", 2, 35000, 10000, false, -1, "icons\ico_blastingCharge.paa")
	VITEMMACRO(lostcargo, "STR_Item_lostcargo", "lostcargo", 12, -1, 95000, false, -1, "icons\ico_storageSmall.paa")
	
	VITEMMACRO(gpstracker, "STR_Item_gpstracker", "gpstracker", 2, 15000, 500, false, -1, "")
	VITEMMACRO(speedbomb, "STR_Item_speedbomb", "speedbomb", 2, 15000, 500, true, -1, "icons\ico_blastingCharge.paa")
	
	VITEMMACRO(bottledwhiskey, "STR_Item_bottledwhiskey", "bottledwhiskey", 2, 2000, 500, true, -1, "icons\ico_waterBottle.paa")
	VITEMMACRO(bottledshine, "STR_Item_bottledshine", "bottledshine", 1, 2000, 500, true, -1, "icons\ico_waterBottle.paa")
	VITEMMACRO(kegshine, "STR_Item_kegshine", "kegshine", 1, 2000, 500, true, -1, "icons\ico_whiskeybarrel.paa")
	VITEMMACRO(bottledbeer, "STR_Item_bottledbeer", "bottledbeer", 2, 2000, 500, false, -1, "icons\ico_beer.paa")
...
class Licenses {
	...
	LICENSEMACRO(heroin,"STR_License_Heroin","heroin",0,true,"civ")
	LICENSEMACRO(kegshine,"STR_License_Kegshine","kegshine",0,true,"civ")
	LICENSEMACRO(mash,"STR_License_Mash","mash",0,true,"civ")
	LICENSEMACRO(meth,"STR_License_Meth","meth",0,true,"civ")
	LICENSEMACRO(marijuana,"STR_License_Marijuana","marijuana",0,true,"civ")
	...
	LICENSEMACRO(cocaine,"STR_License_Cocaine","cocaine",0,false,"civ")
	...
	LICENSEMACRO(taxi,"STR_License_Taxi","taxi",25000,false,"civ")
	LICENSEMACRO(frog,"STR_License_Frog","frog",30000,false,"civ")
	LICENSEMACRO(magicm,"STR_License_Magicm","magicm",0,false,"civ")
...
class VirtualShops {
	...
	class com {
		name = "STR_Shops_Com";
		items[] = { "glass","iron_refined", "copper_refined","diamond_uncut", "diamond_cut", "salt_refined", "cement","oil_processed", "pickaxe", "fuelFull"  };
	};
