...
_role1 = "Hello!";
_role1names = ["Welcome to", "Trole RP AltisLife"];
_role2 = "Teamspeak";
_role2names = ["Ts3.TrolePlay.com"];
_role3 = "Website";
_role3names = ["troleplay.com"];
_role4 = "Built from Altis Life 4.0.0";
_role4names = ["by the TroleDevTeam"];
_role5 = "Developers";
_role5names = ["Derek","UnNamed","Hohum","Many Various Devs"];
_role6 = "Admins";
_role6names = ["UnNamed","Toad","Hohum"];
_role7 = "Moderators";
_role7names = ["TBA"];
